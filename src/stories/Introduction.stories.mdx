...
# Welcome to Faiyt.dev Component Library

Using Storybook to build UI components in isolation from your app's business logic, data, and context.
That makes it easy to develop hard-to-reach states. Saves these UI states as **stories** to revisit during development, testing, or QA.


UI is built using the following methodology [**component-driven**](https://componentdriven.org) process starting with atomic components and ending with pages.
